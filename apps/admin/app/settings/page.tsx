...
export default function SettingsPage() {
    ...
    const handleSave = () => {
        ...
        setError('');
        setTimeout(() => {
            setSuccess(t('admin', 'settings_saveSuccess'));
            setSaving(false);
        }, 500);
    };
        ...
        <div className="p-6 space-y-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl text-center">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">{t('admin', 'settings_pendingKYC')}</p>
                    </div>
                    <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-xl text-center">
                        <p className="text-2xl font-bold text-green-600">{stats.approvedKYC}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">{t('admin', 'settings_approvedKYC')}</p>
                    </div>
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl text-center">
                        <p className="text-2xl font-bold text-blue-600">{stats.totalDocuments}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">{t('admin', 'settings_documents')}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('admin', 'settings_platformName')}</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('admin', 'settings_adminEmail')}</label>
                            <input type="email" value={settings.adminEmail} onChange={(e) => setSettings({ ...settings, adminEmail: e.target.value })}
                                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-600" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('admin', 'settings_supportEmail')}</label>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="space-y-4">
                    {[
                        { key: 'newInstitution', label: t('admin', 'settings_notif_newInstitution'), desc: t('admin', 'settings_notif_newInstitution_desc') },
                        { key: 'kycSubmission', label: t('admin', 'settings_notif_kycSubmission'), desc: t('admin', 'settings_notif_kycSubmission_desc') },
                        { key: 'newSubscription', label: t('admin', 'settings_notif_newSubscription'), desc: t('admin', 'settings_notif_newSubscription_desc') },
                        { key: 'systemAlerts', label: t('admin', 'settings_notif_systemAlerts'), desc: t('admin', 'settings_notif_systemAlerts_desc') },
                    ].map((item) => (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        <div>
                            <p className="font-medium text-gray-900 dark:text-white">{t('admin', 'settings_twoFactor')}</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">{t('admin', 'settings_twoFactor_desc')}</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('admin', 'settings_sessionTimeout')}</label>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="flex gap-2">
                    ...
                    <button className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium">{t('admin', 'settings_regenerate')}</button>
                </div>
            </div>
