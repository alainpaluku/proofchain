    ...
    if (loadState === 'error') {
        return (
            <div className={`flex flex-col items-center justify-center bg-auralis-surface-container-low dark:bg-black/20 p-8 rounded-xl border border-auralis-surface-highest dark:border-auralis-on-surface-variant ${className}`}>
                ...
                <button
                    onClick={handleRetry}
                    className="flex items-center gap-2 px-6 py-2 bg-primary-900 dark:bg-primary-600 text-white rounded-lg text-sm font-bold transition-all hover:scale-105 active:scale-95"
                >
